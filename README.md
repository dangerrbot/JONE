...
اختبار على أوبونتو 14.04 ، ل مرصد الصحراء والساحل أخرى تحقق من 
...
تمكين المزيد من الإضافات

انظر قائمة الإضافات مع! الإضافات الأوامر.

تمكين المساعد تعطيل كتبها! الإضافات تمكن  اسم  .

تعطيل البرنامج المساعد تمكين كتبها! الإضافات تعطيل اسم  .

تلك الأوامر تتطلب مستخدم متميزة ، يتم تعريف المستخدمين متميز داخل البيانات / config.lua ( التي تم إنشاؤها بواسطة بوت ) ، وقف بوت و تحرير إذا لزم الأمر.
...
Contact me
------------
You can contact me [via Telegram](https://telegram.me/amody7)if you have an issue please [open](https://github.com/amody5/JONES/issues) one.

[Join](https://telegram.me/joinchat/B-CebwaDxjasimf5fugN8A) on the TelegramBot Discussion Group.
